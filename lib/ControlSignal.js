...
ControlSignal = (function() {
  ...
  */
  ...
  function ControlSignal(arity, iterator, initialValue) {
    this.arity = arity;
  ...
  ControlSignal.prototype.addSlot = function(slot) {
    /*
  ...
  ControlSignal.prototype.removeSlot = function(slot) {
    /*
  ...
  ControlSignal.prototype.slotCount = function() {
    /*
    ...
    */
    ...
    async.map(this._slots, function(slot, iteratorCallback) {
      ...
      if (error != null) {
        ...
        try {
          result = slotsResults.reduce(_this.iterator, _this.initialValue);
  ...
  ControlSignal.arrayControlSignal = function(arity) {
    ...
    */
    ...
    return new ControlSignal(arity, function(previousValue, currentValue) {
